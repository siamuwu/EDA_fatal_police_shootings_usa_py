...
* Analyzed age, gender, race, and mental illness
* Explored weapons, flee status, and body camera usage
* Visualized state-wise and yearly trends
* Created geospatial heatmaps of incidents
* Focused insights on unarmed, underage, and senior victims

---
To see the graphs click ![Images](Images)
